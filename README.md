...
<div align="center">
  <img src="https://raw.githubusercontent.com/rfs-hybrid/42-Common-Core/main/assets/covers/cover-born2beroot-bonus.png" alt="Born2beroot Cover" width="100%" />
</div>
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Scripting-Bash-yellow" />
</div>
...
**System Manuals:**
* `man sudoers` / `man visudo` - Essential manuals for configuring sudo privileges and strict security policies.
* `man ufw` / `man firewalld` - Manuals for configuring the required host firewalls and managing open ports.
* `man cron` / `man crontab` - Manuals detailing the scheduling daemon used to run the `monitoring.sh` script every 10 minutes.
* `man sshd_config` - Reference for configuring the OpenSSH daemon, restricting root login, and altering the default port.
* `man lvm` - Overview of the Logical Volume Manager used for partitioning.

**Official Documentation:**
* **[Debian Official Documentation](https://www.debian.org/doc/):** The ultimate source of truth for Debian package management and system administration.
* **[Rocky Linux Official Documentation](https://docs.rockylinux.org/):** Core documentation for Rocky Linux and RHEL-compatible configurations.

**Articles & Guides:**
* **[My experience with the Born2beRoot project 42 (Medium)](https://m4nnb3ll.medium.com/my-experience-with-the-born2beroot-project-42-ad19d738ad4f):** A fantastic, detailed walkthrough by MannBell covering the entire setup process, LVM configurations, and evaluation questions.
* **[Born2beroot by Baigal (Medium)](https://baigal.medium.com/born2beroot-e6e26dfb50ac):** An excellent conceptual guide focusing on the *why* behind the configurations, including SSH, UFW, and AppArmor.
* **[Oceano's Born2beroot-Tutorial (GitHub)](https://github.com/suspectedoceano/Born2beroot-Tutorial):** A highly popular, step-by-step 42 community tutorial by Oceano that visually explains partitioning, sudo configurations, and WordPress bonus setups.

---

### 🤖 AI Usage & Transparency
In the spirit of transparency and the learning objectives of the 42 curriculum (specifically adhering to the pedagogical guidelines emphasizing genuine intellectual effort over AI shortcuts), here is how AI tools were utilized during this project:

* **Formatting & Structuring:** AI tools were utilized to format the layout of this `README.md` and generate the theoretical comparison tables required by the subject for the defense.
* **Script Syntax Brainstorming:** Used as a sounding board to brainstorm and validate the specific bash syntax and `awk`/`grep` piping required for text scraping in the `monitoring.sh` script.
* **Zero Configuration Generation:** **No direct VM configurations, security policies, or partition schemes were generated by AI.** All Logical Volume Management (LVM), service installations (SSH, UFW, lighttpd, MariaDB), and strict security policy enforcements were 100% manually researched, executed, and tested to guarantee a foundational mastery of Linux system administration.
